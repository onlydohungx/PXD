...
export default function SeriesPage() {
  ...
  const { data: moviesData, isLoading: isMoviesLoading } = useQuery({
    queryKey: ['/api/movies/series', page, selectedCategory, selectedCountry, selectedYear, selectedSort],
    queryFn: () => fetchMovies({ 
      page,
      ...
      year: selectedYear,
      sort: selectedSort,
      type: "series" // Quan trọng: Đây là tham số xác định đây là trang phim bộ
    }),
  });
    ...
    <div className="pt-4 pb-12 px-4 md:px-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Tổng hợp những bộ phim truyền hình, phim bộ mới nhất và hấp dẫn nhất
        </p>
      </div>
